                                ...
                                <div className='space-y-5'>
                                    ...
                                    <div className='space-y-2'>
                                        ...
                                        <textarea
                                            ...
                                            className='w-full px-4 py-3 rounded-lg border border-white/10 bg-white/6 text-zince-100 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-pink-500 resize-none'
                                        />
                                    </div>
